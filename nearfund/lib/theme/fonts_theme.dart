...
final customFontStyle = TextTheme(
  ...
  headline3: GoogleFonts.prompt(fontSize: 53, fontWeight: FontWeight.w400),
  headline4: GoogleFonts.prompt(
      fontSize: 38, fontWeight: FontWeight.w400, letterSpacing: 0.25),
  headline5: GoogleFonts.prompt(fontSize: 27, fontWeight: FontWeight.w400),
